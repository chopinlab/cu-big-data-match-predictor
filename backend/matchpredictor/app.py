...
def build_model_provider(training_data: List[Result]) -> ModelProvider:
    return ModelProvider([
        ...
        # (Added) The alphabet predictor is a simple predictor that predicts the result based on the first letter of the home team
        Model("Alphabet", AlphabetPredictor()),

        # (Added) New Model, Add a model that uses score_difference_predictor.py 
        Model("Score Difference", ScoreDifferencePredictor(training_data)),
